...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn(
      "text-2xl text-center font-semibold [&+div]:text-xs",
      className
    )}
    {...props}
  />
